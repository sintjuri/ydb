...
* `DROP NOT NULL` is supported for non-key columns of [row-oriented tables](../../../../concepts/datamodel/table.md#row-oriented-tables) and [column-oriented tables](../../../../concepts/datamodel/table.md#column-oriented-tables).
